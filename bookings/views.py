...
from .serializers import BookingCreateSerializer, BookingDetailSerializer, RoomTypeSerializer
...
class RoomSearchAPIView(APIView):
    ...
    @extend_schema(
        parameters=[
            OpenApiParameter(name='check_in', description='Start Date', required=True, type=OpenApiTypes.DATE),
            OpenApiParameter(name='check_out', description='End Date', required=True, type=OpenApiTypes.DATE),
        ],
